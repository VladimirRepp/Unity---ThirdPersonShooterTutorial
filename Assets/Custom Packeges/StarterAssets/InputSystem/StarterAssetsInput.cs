...
//     version 1.14.2
//     from Assets/AssetStore/StarterAssets/InputSystem/StarterAssetsInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/AssetStore/StarterAssets/InputSystem/StarterAssetsInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @StarterAssetsInput : IInputActionCollection2, IDisposable
{
    ...
    ~@StarterAssetsInput()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, StarterAssetsInput.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Shooting.enabled, "This will cause a leak and performance issues, StarterAssetsInput.Shooting.Disable() has not been called.");
    }
    ...
    public struct ShootingActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ShootingActions(@StarterAssetsInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
